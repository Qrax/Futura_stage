...
def generate_plot_peak_prominence(dfs, act_lbls, settings, sum_cache, plt_instance):
    ...
    en toont de resultaten in een bar chart.
    """
    ...
    for i, lbl in enumerate(act_lbls):
        ...
        # Gebruik dezelfde segment-extractie als in de periodogram-plot
        ...
        periods, mags, _ = _calculate_generic_periodogram_common(
            ...
            settings.MIN_PERIOD_PLOT * settings.SAMPLE_TIME_DELTA_US,
            settings.MAX_PERIOD_PLOT_ABS * settings.SAMPLE_TIME_DELTA_US
        )
